...
(df navbar-view [] -> Str
  ...
  "(nav (:class \"sticky top-0 z-50 backdrop-blur-md bg-surface/80 border-b border-line px-6 py-4 flex items-center justify-between\")
    ...
    (div (:class \"flex items-center gap-6 text-sm font-medium text-ink-muted\")
      ...
      (a (:href \"#docs\" :class \"hover:text-signal transition\") \"Documentation\")
      (a (:href \"https://github.com/aovestdipaperino/aslang\" :class \"px-4 py-2 rounded-xl bg-signal text-ground font-semibold hover:opacity-90 transition\") \"GitHub\")))")
