...
| `blank?` | `string-empty?` |
| `substr` | `string-slice` |
| `str-find` | `string-index-of` |
| `includes?` | `string-contains?` |
| `lower` | `string-lower` |
| `strrev` | `string-reverse` |
| `replace` | `string-replace` |
| `str-i` | `string-from-int64` |
| `str-f` | `string-from-float64` |
| `widen` | `int32-to-int64` |
| `narrow` | `int64-to-int32` |
| `float` | `int64-to-float64` |
| `trunc` | `float64-to-int64` |
| `contains?` | `list-contains?` |
| `index-of` | `list-index-of` |
| `sort-by` | `list-sort-by` |
| `pairs` | `map-pairs` |
| `to-map` | `map-from-pairs` |
| `err-map` | `result-map-err` |
| `opt-res` | `option-to-result` |
| `res-opt` | `result-to-option` |
