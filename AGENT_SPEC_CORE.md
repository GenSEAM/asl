...
| `starts?` | `string-starts-with?` | call-head |
| `ends?` | `string-ends-with?` | call-head |
| `len` | `list-length` | call-head |
| `head` | `list-head` | call-head |
| `tail` | `list-tail` | call-head |
| `rev` | `list-reverse` | call-head |
| `sum` | `list-sum` | call-head |
| `split` | `string-split` | call-head |
| `join` | `string-join` | call-head |
| `trim` | `string-trim` | call-head |
| `slice` | `list-slice` | call-head |
| `chars` | `string-chars` | call-head |
| `f64` | `string-to-float64` | call-head |
| `i64` | `string-to-int64` | call-head |
| `keys` | `map-keys` | call-head |
| `vals` | `map-values` | call-head |
| `has?` | `map-has?` | call-head |
| `empty?` | `list-empty?` | call-head |
| `some?` | `is-some?` | call-head |
| `none?` | `is-none?` | call-head |
| `ok?` | `is-ok?` | call-head |
| `err?` | `is-err?` | call-head |
| `blank?` | `string-empty?` | call-head |
| `substr` | `string-slice` | call-head |
| `str-find` | `string-index-of` | call-head |
| `includes?` | `string-contains?` | call-head |
| `lower` | `string-lower` | call-head |
| `strrev` | `string-reverse` | call-head |
| `replace` | `string-replace` | call-head |
| `str-i` | `string-from-int64` | call-head |
| `str-f` | `string-from-float64` | call-head |
| `widen` | `int32-to-int64` | call-head |
| `narrow` | `int64-to-int32` | call-head |
| `float` | `int64-to-float64` | call-head |
| `trunc` | `float64-to-int64` | call-head |
| `contains?` | `list-contains?` | call-head |
| `index-of` | `list-index-of` | call-head |
| `sort-by` | `list-sort-by` | call-head |
| `pairs` | `map-pairs` | call-head |
| `to-map` | `map-from-pairs` | call-head |
| `err-map` | `result-map-err` | call-head |
| `opt-res` | `option-to-result` | call-head |
| `res-opt` | `result-to-option` | call-head |
| `denied` | `permission-denied` | call-head |
| `exists` | `already-exists` | call-head |
| `exists?` | `file-exists?` | call-head |
| `append` | `list-append` | call-head |
| `append-file` | `file-append` | call-head |
