...
(df testC99ArithmeticAndPrecedence [] -> Bool
  ...
  (let [(addNode (rd/sexprList (list (rd/sexprAtom "+") (rd/sexprAtom "1") (rd/sexprAtom "2"))))
        ...
        (eAdd (ex/lowerCExpr addNode))
        (eSub (ex/lowerCExpr subNode))
        (eNeg (ex/lowerCExpr negNode))
        (eDiv (ex/lowerCExpr divNode))
        (eMul (ex/lowerCExpr mulNode))]
...
(df testC99LogicAndComparisons [] -> Bool
  ...
  (let [(eqNode (rd/sexprList (list (rd/sexprAtom "=") (rd/sexprAtom "x") (rd/sexprAtom "y"))))
        ...
        (eEq (ex/lowerCExpr eqNode))
        (eNeq (ex/lowerCExpr neqNode))
        (eLt (ex/lowerCExpr ltNode))
        (eAnd (ex/lowerCExpr andNode))
        (eOr (ex/lowerCExpr orNode))
        (eNot (ex/lowerCExpr notNode))]
...
(df testC99ConditionalsAndLet [] -> Bool
  ...
  (let [(ifNode (rd/sexprList (list (rd/sexprAtom "if") (rd/sexprAtom "true") (rd/sexprAtom "1") (rd/sexprAtom "0"))))
        ...
        (eLetTyped (ex/lowerCExpr letTypedNode))]
...
(df testC99RecordsAndMatching [] -> Bool
  ...
  (let [(fAccess (ex/lowerCFieldAccess "person" "age"))
        ...
        (eField (ex/lowerCExpr fAccessExpr))
        (recNode (rd/sexprList (list (rd/sexprAtom "Person")
                                     (rd/sexprAtom ":name")
                                     (rd/sexprAtom "\"Alice\"")
                                     (rd/sexprAtom ":age")
                                     (rd/sexprAtom "30"))))
        (eRec (ex/lowerCExpr recNode))
        ...
        (eMatch (ex/lowerCExpr matchNode))
        ...
        (eMatchQual (ex/lowerCExpr matchQualNode))]
