...
(df macho_sections [text-size data-size] -> List
  :d "Constructs Mach-O __TEXT and __DATA section descriptors"
  (list
    {:sectname "__text" :segname "__TEXT" :size text-size :flags 2147484672}
    {:sectname "__data" :segname "__DATA" :size data-size :flags 3}))
...
(df emit_macho_arm64 [ir-nodes] -> Map
