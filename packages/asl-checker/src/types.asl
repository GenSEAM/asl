...
(df builtinSig [(name String)] -> (Option (Pair (List String) (Pair Bool String)))
  ...
  (cond
    ...
    ((= name "bytesAlloc") (sigFn (list "Int64") "Bytes"))
    ((= name "bytesLength") (sigFn (list "Bytes") "Int64"))
    ((= name "bytesGetF64") (sigFn (list "Bytes" "Int64") "Float64"))
    ((= name "bytesSetF64") (sigFn (list "Bytes" "Int64" "Float64") "Unit"))
    ((= name "bytesToBase64") (sigFn (list "Bytes") "String"))
    ((= name "bytesFromBase64") (sigFn (list "String") "Bytes"))
    ...
    ((= name "hostSocketOpen") (sigFn (list "String" "Int64" "Bool") "(Result Int64 String)"))
    ((= name "hostSocketBind") (sigFn (list "Int64" "String" "Int64") "(Result Bool String)"))
    ((= name "hostSocketListen") (sigFn (list "Int64" "Int64") "(Result Bool String)"))
    ((= name "hostSocketAccept") (sigFn (list "Int64") "(Result Int64 String)"))
    ((= name "hostSocketRead") (sigFn (list "Int64" "Int64") "(Result String String)"))
    ((= name "hostSocketWrite") (sigFn (list "Int64" "String") "(Result Int64 String)"))
    ((= name "hostSocketClose") (sigFn (list "Int64") "(Result Bool String)"))
    ((= name "hostSocketPoll") (sigFn (list "Int64" "Int64") "(Result String String)"))
    ((= name "hostSurfaceInit") (sigFn (list "String" "Int64" "Int64") "(Result Int64 String)"))
    ((= name "hostSurfacePresent") (sigFn (list "Int64" "String" "Int64") "(Result Bool String)"))
    ((= name "hostSurfaceResize") (sigFn (list "Int64" "Int64" "Int64") "(Result Bool String)"))
    ((= name "hostSurfacePollEvents") (sigFn (list "Int64") "(Result String String)"))
    (:else (none))))
